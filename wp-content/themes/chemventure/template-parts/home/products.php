<section class="home-section home-section-muted" id="products" data-section="products">
    <div class="cv-container">
        <div class="section-heading" data-reveal>
            <div>
                <p class="home-eyebrow home-eyebrow-dark">Product Range</p>
                <h2>Powder coating systems for different performance needs.</h2>
            </div>
            <p>Green Paints offers three core thermosetting powder coating chemistries documented in the supplied catalogue.</p>
        </div>

        <div class="product-grid">
            <article class="product-card" data-reveal>
                <div class="product-topline"><span class="product-family">Chemical resistance</span><span class="product-chip">Interior and functional use</span></div>
                <h3>Pure Epoxy</h3>
            ...
            <article class="product-card product-card-featured" data-reveal>
                <div class="product-topline"><span class="product-family">Durable coating</span><span class="product-chip">Versatile finish range</span></div>
            ...
            <article class="product-card" data-reveal>
                <div class="product-topline"><span class="product-family">Weather resistance</span><span class="product-chip">Recommended for exterior use</span></div>
        ...
        <div class="product-support" data-reveal>
            <div><strong>Not sure which chemistry fits your requirement?</strong><span>Share the substrate, finish and application with the ChemVenture team.</span></div>
            <a href="#enquiry">Discuss your requirement <span>→</span></a>
        </div>
    </div>
</section>
