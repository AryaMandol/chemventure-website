...
| CV-05 | Polish, mobile, SEO + hardening | In progress |
...
CV-05 adds lightweight homepage SEO metadata, Organization/WebSite schema, local-development `noindex`, progressive-enhancement safeguards, security headers, responsive/accessibility refinements and consent-gated GTM loading.

See [`docs/CV-05-POLISH-SEO-HARDENING.md`](docs/CV-05-POLISH-SEO-HARDENING.md).
