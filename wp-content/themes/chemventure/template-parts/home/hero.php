    ...
    <div class="cv-container hero-content">
        <div class="hero-copy" data-reveal>
            ...
            <div class="hero-actions">
                ...
                <a class="cv-button cv-button--whatsapp cv-button--large" href="<?php echo esc_url( chemventure_whatsapp_href( '', 'Hi, I am interested in Green Paints powder coating solutions. Please help me with my requirement.' ) ); ?>" target="_blank" rel="noopener" data-cv-event="whatsapp_click" data-cv-location="hero"><?php chemventure_whatsapp_icon(); ?><span>WhatsApp</span></a>
