...
<div class="cv-utility-bar">
    <div class="cv-container cv-utility-bar__inner">
        ...
        <div class="cv-utility-links">
            <?php if ( $phone ) : ?>
                <a href="<?php echo esc_url( chemventure_phone_href( $phone ) ); ?>"><?php echo esc_html( $phone ); ?></a>
            <?php endif; ?>
            <?php if ( $whatsapp ) : ?>
                <a href="<?php echo esc_url( chemventure_whatsapp_href( $whatsapp ) ); ?>" target="_blank" rel="noopener">WhatsApp</a>
            <?php endif; ?>
        </div>
    </div>
</div>
