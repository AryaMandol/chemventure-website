...
function chemventure_customize_register( $wp_customize ) {
    ...
    chemventure_add_text_control( $wp_customize, 'lead_recipient_email', 'chemventure_leads_tracking', __( 'Lead notification email', 'chemventure' ), get_option( 'admin_email' ), 'sanitize_email', 'email' );
    chemventure_add_text_control( $wp_customize, 'gtm_container_id', 'chemventure_leads_tracking', __( 'Google Tag Manager Container ID', 'chemventure' ), '', 'sanitize_text_field' );

    $wp_customize->add_setting(
        'tracking_enabled',
        array(
            'default'           => false,
            'sanitize_callback' => 'chemventure_sanitize_checkbox',
            'transport'         => 'refresh',
        )
    );
    ...
    chemventure_add_text_control(
        ...
        'chemventure_seo_privacy',
        __( 'Privacy contact email', 'chemventure' ),
        '',
        'sanitize_email',
        'email'
    );
 ...
 */
function chemventure_sanitize_checkbox( $checked ) {
    return (bool) $checked;
}
